...
public class ControllerTest {
    ...
    @InjectMocks
    @Spy
    private FlussoSismResidenzialeAnagControllerRest controller;
    ...
    @Mock
    private FlussoSismResServiceAnagrafica service;
    private ConfigurazioneFlussoSismResAnag.Rules rules = mock(ConfigurazioneFlussoSismResAnag.Rules.class);

    private ConfigurazioneFlussoSismResAnag.Flusso flusso = mock(ConfigurazioneFlussoSismResAnag.Flusso.class);
    ...
    private ConfigurazioneFlussoSismResAnag.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoSismResAnag.NomeFlusso.class);
